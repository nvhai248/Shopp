...
const MainFooter = () => {
  return (
    <footer>
      <div className="bg-black text-white flex pt-4 pb-10 pl-40 pr-40 text-left">
        {/* ABOUT US */}
        <div className="flex flex-col items-left justify-top w-1/3">
          <h2 className="text-xl font-bold mb-2">
            <span className="pr-2 border-r-2 border-blue-500">About Us</span>{" "}
          </h2>
        ...
        <div className="flex flex-col items-left justify-top w-1/3">
          <h2 className="text-xl font-bold mb-2">
            <span className="pr-2 border-r-2 border-blue-500">Newsletter</span>{" "}
          </h2>
          <p className="mt-3">Subscribe now and receive weekly newsletter</p>
      ...
      <div className="bg-gray-800 text-white flex py-4 text-center">
